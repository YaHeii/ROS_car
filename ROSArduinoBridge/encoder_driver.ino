...
void initEncoders(){
  ...
  attachInterrupt(digitalPinToInterrupt(ENC_LEFT_PINA),encoderLeftISR,FALLING);  
    
  pinMode(ENC_RIGHT_PINA, INPUT);
  pinMode(ENC_RIGHT_PINB, INPUT);
  attachInterrupt(digitalPinToInterrupt(ENC_RIGHT_PINA),encoderRightISR,FALLING);
